...
function preload() {
  ...
  tImage=loadImage("images/tree-standing.png")var canvas;
var greenHero, hImage;
var weapon,weaponImg;
var bgImg,bgSprite;
var tree,tcImage,treeCutter,tImage,tcAnimation,tdAnimation;
      ...
      if (obstacle!==undefined) {
        ...
        for(var k=0;k<obstacleGrp.length;k++) {
          if (weaponGrp.isTouching(obstacleGrp.get(k))) {
            obstacleGrp.get(k).changeAnimation("treecutter-die",tdAnimation);
            weapon.velocityX=0;
            obstacleGrp.get(k).lifetime=2
      ...
      if (obstacle2!==undefined) {
        ...
        for(var k=0;k<obstacle2Grp.length;k++) {
          if (weaponGrp.isTouching(obstacle2Grp.get(k))) {
            obstacle2Grp.get(k).changeAnimation("treecutter-die",tdAnimation);
            weapon.velocityX=0;
            obstacle2Grp.get(k).lifetime=2
      ...
      if (obstacle3!==undefined) {
        ...
        for(var k=0;k<obstacle3Grp.length;k++) {
          if (weaponGrp.isTouching(obstacle3Grp.get(k))) {
            obstacle3Grp.get(k).changeAnimation("treecutter-die",tdAnimation);
            weapon.velocityX=0;
            obstacle3Grp.get(k).lifetime=2
      ...
      if (obstacle4!==undefined) {
        ...
        for(var k=0;k<obstacle4Grp.length;k++) {
          if (weaponGrp.isTouching(obstacle4Grp.get(k))) {
            obstacle4Grp.get(k).changeAnimation("treecutter-die",tdAnimation);
            weapon.velocityX=0;
            obstacle4Grp.get(k).lifetime=2
